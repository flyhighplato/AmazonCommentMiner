...
if not is_win32:
	svmscale_exe = "../libs/libsvm-3.0/svm-scale"
	svmtrain_exe = "../libs/libsvm-3.0/svm-train"
	svmpredict_exe = "../libs/libsvm-3.0/svm-predict"
	grid_py = "../libs/libsvm-3.0/tools/grid.py"
